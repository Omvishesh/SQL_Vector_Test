...
def get_search_results(milvus_client, collection_name, query_vector, output_fields=["id", "source", "page", "content", "reference", "date", "url"],
...
def get_chunks_by_reference_page_pairs(
    ...
    collection_name,
    pairs,
    output_fields=["id", "source", "page", "content", "reference", "date", "url"]
):
    """
